...
public class HTMLParser {
	...
	public Vector<String> splitHTML(String html) {
		...
		Pattern p = Pattern.compile("action-type=\\\\\"feed_list_item\\\\\".+?好友转发去掉");
		Matcher m = p.matcher(html);
		while(m.find()) {
			String temp = m.group().replace("action-type=\\\"feed_list_item\\\">","<start>")
					.replace("<!-- 好友转发去掉","</start>");
...
//		//dirPath = "e:/tweet/tweettxt/searchword";
